...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/numba-scipy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8432&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/numba-scipy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `numba-scipy` can be installed with:

```
conda install numba-scipy
```

It is possible to list all of the versions of `numba-scipy` available on your platform with:
